...
<header class="d-flex flex-shrink-0">
    ...
    <div class="container px-md-5 py-md-3 py-3">
        <div class="p-2 p-md-4 bg-white rounded-4 d-flex justify-content-between ">
            <div class="col-6 col-md-4">
                <form class="input-group">
                    <input type="text" class="form-control" placeholder="Поиск..." aria-label="Поиск"
                           aria-describedby="searchButton">
                    <button class="btn btn-primary text-white" type="button" id="searchButton"><i
...
<div class="d-flex flex-grow-1 overflow-hidden">
    ...
    <nav class="navbar col-3 d-none d-md-block py-md-3 px-md-5 py-2 bg-white">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-flex align-items-center">
                ...
                <a class="nav-link" href="{{ route('clients.index') }}">Покупатели</a>
            </li>
            <hr/>
            <li class="nav-item d-flex align-items-center">
    ...
    <div class="container p-0">
        ...
        <main class="container py-md-3 px-md-5 py-3 bg-body">
            @yield('content')
        </main>

        <div class="fixed-bottom container d-flex justify-content-end">
            <button
                class="btn btn-primary text-white rounded-circle d-inline-flex px-2 py-1 mb-4"
